...
function Profile() {
  ...
  const displayName =
    profile?.fullName || profile?.username || user?.displayName || "User";
  ...
  const glassCard =
    "rounded-[20px] border border-[#e2ebff] bg-white/60 p-4 shadow-[0_2px_10px_rgba(13,39,247,0.04)] ring-1 ring-white/70 backdrop-blur-xl transition-all duration-200 hover:-translate-y-[2px] hover:border-[#c3d4ff] hover:shadow-[0_8px_30px_rgba(13,39,247,0.08)] sm:rounded-[22px]";
        ...
        <section className="overflow-hidden rounded-[22px] border border-[#d6e2ff] bg-white/70 shadow-[0_4px_20px_rgba(13,39,247,0.06)] ring-1 ring-white/80 backdrop-blur-xl sm:rounded-[24px]">
          <div className="relative px-4 py-6 sm:px-6 sm:py-7 md:px-8">
            ...
            <div className="relative flex flex-col items-center gap-4 text-center sm:gap-5 md:flex-row md:text-left">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="break-words bg-gradient-to-b from-[#0D27F7] to-[#0E1BEF] bg-clip-text text-2xl font-semibold tracking-tight text-transparent sm:text-3xl">
                  {displayName}
                </h1>
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-b from-[#0D27F7] to-[#0E1BEF] px-5 py-2.5 text-sm font-medium text-white shadow-[0_2px_10px_rgba(13,39,247,0.2)] transition hover:opacity-95 hover:shadow-[0_6px_20px_rgba(13,39,247,0.25)] active:scale-[0.98] sm:w-auto"
              >
                <FiEdit3 />
                Edit Profile
              </button>
          ...
          <div className="grid gap-3 p-4 sm:gap-4 sm:p-5 md:grid-cols-2 md:p-7">
            <div className={glassCard}>
              ...
              <h3 className="mt-1.5 break-words text-sm font-medium text-gray-800">
                {displayUsername}
              </h3>
            </div>
            ...
            <div className={glassCard}>
              ...
              <h3 className="mt-1.5 flex items-center gap-2 break-words text-sm font-medium text-gray-800">
                {displayCountryCode ? (
                  <span
