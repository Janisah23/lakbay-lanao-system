...
const CATEGORIES = ["All", "Cultural", "Heritage", "Mosque", "Torogan", "Festival", "Historic"];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const culturalOnly = combined.filter((item) => {
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2563eb] leading-tight tracking-tight">
              Cultural<br className="hidden md:block" /> Heritage
            </h1>
            <p className="mt-3 text-gray-500 max-w-md text-base font-light leading-relaxed">
              Discover traditions, sacred spaces, and heritage sites that reflect the rich identity of the Meranaw people.
            </p>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 pt-10">
        {filteredData.length === 0 ? (
          <div className="py-20 text-center bg-white rounded-[28px] border border-dashed border-gray-200">
            <p className="text-gray-400 text-sm font-medium">No cultural heritage items found.</p>
            <button
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="inline-block rounded-full bg-[#2563eb] px-2.5 py-1 text-[10px] font-bold text-white uppercase tracking-wider shadow-sm mb-1.5">
                      {item.type || item.category || "Cultural Site"}
                    </span>
                    ...
                    <p className="text-sm text-gray-400 mt-1 line-clamp-1 font-light">
                      {item.description || item.summary || "Discover cultural heritage in Lanao."}
                    </p>
                ...
                >
                  ...
                  <div className="absolute top-5 left-5">
                    <span className="rounded-full bg-[#2563eb] px-3 py-1 text-[10px] font-bold text-white uppercase tracking-wider shadow-sm">
                      {featuredItem.type || featuredItem.category || "Cultural Site"}
                    </span>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="text-white/70 text-sm line-clamp-2 font-light">
                      {featuredItem.description || featuredItem.summary || "Discover cultural heritage in Lanao."}
                    </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#2563eb] tracking-tight leading-tight">
                Experience the living<br className="hidden md:block" /> culture of Lanao
              </h2>

              <p className="mt-5 text-sm text-gray-500 leading-relaxed max-w-md">
                Discover traditions, sacred spaces, and heritage sites that continue to shape the identity of Lanao del Sur.
              </p>

              <div className="flex gap-6 mt-6">
                <div>
                  <p className="text-2xl font-bold text-[#2563eb]">{filteredData.length}+</p>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Heritage Sites</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-[#2563eb]">Rich</p>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Traditions</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-[#2563eb]">Living</p>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Culture</p>
                </div>
              </div>
              ...
              >
                Explore cultural sites <FiChevronRight />
              </button>
            </div>
              ...
              <div className="absolute inset-0 grid grid-cols-2 gap-3 p-4">
                <div className="rounded-[18px] overflow-hidden">
                  <img
                    ...
                    alt={filteredData[0]?.title || "Cultural site"}
                ...
                <div className="grid grid-rows-2 gap-3">
                  <div className="rounded-[18px] overflow-hidden">
                    <img
                      ...
                      alt={filteredData[1]?.title || "Heritage site"}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  ...
                  <div className="rounded-[18px] overflow-hidden">
                    <img
                      ...
                      alt={filteredData[2]?.title || "Cultural landmark"}
                      className="w-full h-full object-cover"
                    />
                  </div>
                </div>
