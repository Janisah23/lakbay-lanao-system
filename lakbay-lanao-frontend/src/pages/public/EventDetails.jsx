...
const EventDetails = () => {
  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen bg-gradient-to-br from-white via-[#f8fbff] to-[#eef4ff]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="space-y-5 lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={label} className="flex gap-4 items-start">
                    <span className="text-[#2563eb] text-lg mt-0.5 flex-shrink-0">
                      {icon}
                    </span>
            ...
            <div className="bg-white rounded-[28px] border border-gray-200 shadow-sm p-6 relative">
              {showPopup && (
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-sm font-semibold py-2.5 px-5 rounded-full shadow-xl flex items-center gap-2 z-50">
                  ✔ Rating submitted!
                </div>
              )}
              ...
              <button
                ...
                className={`w-full mt-4 font-semibold py-3 rounded-full transition-all duration-300 ${
                  isSubmitted
      ...
      {/* ── MORE TO EXPLORE ── */}
      <section className="py-20 px-6 bg-white border-t border-gray-100 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              {morePlaces.slice(0, 4).map((place) => (
                <button
                  key={place.id}
                  type="button"
                  onClick={() => handleMoreEventClick(place.id)}
                  className="group block w-full cursor-pointer text-left bg-white rounded-[20px] border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden"
                >
                  ...
                  <div className="p-4">
                    <h4 className="font-semibold text-[#2563eb] text-[14px] line-clamp-1">
                      {place.title}
                    </h4>
