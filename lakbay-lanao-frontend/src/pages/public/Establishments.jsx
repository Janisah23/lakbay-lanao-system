...
function HotelsAndRestaurants() {
  ...
  const getPlaceTitle = (item) => {
    return item.title || item.name || "Untitled Establishment";
  };
        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-md text-base font-light leading-relaxed text-gray-500">
              Find the perfect place to stay and dine. Explore hotels, cozy
              resorts, local restaurants, and cafes around Lanao del Sur.
            </p>
          </div>
