 ...
 useEffect(() => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-semibold text-[#2563EB]">AI Knowledge Base</h2>
      ...
      {toast && (
        <div
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium shadow-sm border
            ${toast.type === "success"
      ...
      >
        ...
        {uploading ? (
          <>
            ...
            <p className="text-sm font-medium text-[#2563EB]">Processing & embedding document…</p>
            <p className="text-xs text-gray-400">This may take a few minutes for larger files</p>
          </>
        ) : fileToConfirm ? (
          <div className="text-center z-10 w-full max-w-md bg-white border border-blue-100 shadow-sm p-6 rounded-xl animate-fadeIn">
            <FiFileText className="text-4xl text-[#2563EB] mx-auto mb-3" />
            <p className="text-sm font-semibold text-gray-800 mb-1">Upload Confirmation</p>
            <p className="text-xs text-gray-500 mb-6 truncate px-4">
              Are you sure you want to process <strong className="text-gray-800">{fileToConfirm.name}</strong>?
            </p>
            
            <div className="flex gap-3 justify-center">
              <button
                onClick={(e) => { e.stopPropagation(); setFileToConfirm(null); fileRef.current.value = ""; }}
              ...
              <button
                ...
                className="px-5 py-2 text-sm font-medium text-white bg-[#2563EB] hover:bg-blue-700 rounded-lg shadow-sm transition"
              >
                Process File
              </button>
            </div>
          ...
          <>
            ...
            <div className="text-center pointer-events-none">
              <p className="text-sm font-medium text-gray-800">
                Drag & drop a file here, or <span className="text-[#2563EB] underline">click to browse</span>
              </p>
            ...
            {documents.map((doc) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-4 shrink-0 flex items-center gap-1.5 text-xs text-red-500
                    hover:text-red-700 hover:bg-red-50 rounded-lg px-3 py-1.5 transition disabled:opacity-50"
                >
