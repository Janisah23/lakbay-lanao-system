            ...
            <div className="bg-white rounded-[28px] border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full flex items-center gap-3 p-4 bg-gray-50 rounded-[16px] border border-gray-100 transition hover:border-[#2563eb] hover:bg-blue-50 group"
                >
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-gray-500 group-hover:text-[#2563eb] shadow-sm">
                    <FiPlus />
                  </div>
                  <span className="text-sm font-bold text-gray-700 group-hover:text-[#2563eb]">Add Destination</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm font-bold text-gray-700 group-hover:text-[#2563eb]">Write Article/Event</span>
                </button>
                ...
                >
                  ...
                  <span className="text-sm font-bold text-gray-700 group-hover:text-[#2563eb]">Manage Gallery</span>
                </button>
              </div>
            </div>
                      ...
                      <div key={review.id} className="flex items-start gap-4 p-3 rounded-[16px] hover:bg-gray-50 transition border border-transparent hover:border-gray-100">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-gray-500 line-clamp-2 leading-relaxed">
                            {review.comment || "Rated without leaving a text comment."}
                          </p>
                        </div>
                      </div>
                    );
